...
#define SWIGV8_INIT gpio_initialize




static SwigV8ReturnValue _wrap_pinMode(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  ...
  if(args.Length() != 2) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_pinMode.");
  ...
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "pinMode" "', argument " "2"" of type '" "char *""'");
  }
  arg2 = (char *)(buf2);
  pinMode(arg1,arg2);
...
static SwigV8ReturnValue _wrap_digitalWrite(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  ...
  if(args.Length() != 2) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_digitalWrite.");
...
static SwigV8ReturnValue _wrap_digitalRead(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  ...
  if(args.Length() != 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_digitalRead.");
...
static SwigV8ReturnValue _wrap_blink(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  ...
  if(args.Length() != 3) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_blink.");
  ...
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "blink" "', argument " "2"" of type '" "float""'");
  } 
  arg2 = (float)(val2);
  ecode3 = SWIG_AsVal_int(args[2], &val3);
  if (!SWIG_IsOK(ecode3)) {
    SWIG_exception_fail(SWIG_ArgError(ecode3), "in method '" "blink" "', argument " "3"" of type '" "int""'");
  } 
  arg3 = (int)(val3);
  blink(arg1,arg2,arg3);
  jsresult = SWIGV8_UNDEFINED();
...
#endif
{
  ...
  SWIGV8_AddStaticFunction(exports_obj, "pinMode", _wrap_pinMode);
SWIGV8_AddStaticFunction(exports_obj, "digitalWrite", _wrap_digitalWrite);
SWIGV8_AddStaticFunction(exports_obj, "digitalRead", _wrap_digitalRead);
SWIGV8_AddStaticFunction(exports_obj, "blink", _wrap_blink);
...
NODE_MODULE(gpio, gpio_initialize)
#endif
